...
def check_is_word(user_input):
    '''This checks a word to see if it's English.
...
def evaluate_input(user_input):
    '''This takes the input as a string, removes the white space and then converts to lower case.  Next, it
    tries to create an Anagram with the word.'''
...
def search_for_anagram(sorted_anagram):
    '''This opens the file and loads it's into a dictionary. It also searches the dictionary for a matching anagram. '''
    try:
